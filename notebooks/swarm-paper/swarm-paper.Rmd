...
TODO introduce construction choice. running river/debris example
- multiple near-synonymous ways to realize the same event / relation in language
- specifically here: construction choice. choice of syntactic structure used to
  relate participants of an event / relation
  - define *construction*
  - TODO figure out current model of production -- still the same two-phase
    thing as presented in Ferreira et al.?
  - other degrees of freedom: word choice, pronominalization
- why do we have this degree of flexibility?
- construction choice can serve multiple discourse functions

### Meaning and construction choice

TODO meaning effect on construction choice
- ref Wolff causative/periphrastic causative
- ref Goldberg meaning extension
- ref Levin verb classes
