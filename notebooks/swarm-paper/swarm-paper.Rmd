...
- approximate inference
  - approximately Bayesian with biased proposal
- modular inference
  - e.g. non-Bayesian discriminative mapping which simply doesn't take into
    account the interaction we are sensitive to here in production
- future work: separating these theories
  - approximate model may be sensitive to priming (e.g. priming the relevant
    meaning contrast), or task effects
  - modular model will not be
