...
```{r 04-plot-raw-responses, warning=FALSE, echo=FALSE, fig.cap="Slider responses by condition. Error bars indicate standard error of the mean. Responses on control items (with ground-truth full or empty locations) are shown as vertical bands, also denoting mean and standard error of the mean."}
df.04.filtered %>% 
