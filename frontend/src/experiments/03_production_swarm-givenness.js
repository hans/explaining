 ...
 *
 * @title 5-10min English writing task (Explaining 03-00)
...
const EXPERIMENT_NAME = "03_production_swarm-givenness";
const MATERIALS_HASH = "swarm-004-given";
const FILLERS_HASH = "fillers/swarm_production-001-twosentences";
  ...
  timeline = timeline.concat([
    {
      ...
      pages: [
        ...
        <p class="jspsych-instructions">
          On each page, we'll present two sequences of sentences which begin the
          same, but which <strong>end in slightly different ways</strong>.
        </p>
        <p class="jspsych-instructions">
          Your job is to pick the passage which sounds the
    ...
    a({
      ...
      questions: [
        {
          prompt:
            "The following two excerpts differ in the way they are " +
            "completed. Which excerpt sounds more " +
            "natural to you?",
          options: _.shuffle([
            {
              value: "good",
  ...
  timeline = timeline.concat(_.map(trial_materials.trials, (trial) => {
    ...
    return {
      ...
      questions: [
        {
          prompt:
            "The following two excerpts differ in the way they end. Which " +
            "excerpt sounds more natural to you?",
          options: sentences,
        },
      ],
